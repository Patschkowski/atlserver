...
BOOL CMainFrame::PreCreateWindow(CREATESTRUCT& cs)
{
    ...
    // Sanity check the values from GetProfileString:
#define CHECKSANE(idx, lo, hi, def) if (prefs[idx] < lo || prefs[idx] > hi) prefs[idx] = def
    CHECKSANE(0, 0, 32700, 10);
    CHECKSANE(1, 0, 32700, 10);
    CHECKSANE(2, prefs[0]+10, 32700, 310);
    CHECKSANE(3, prefs[1]+10, 32700, 310);
    CHECKSANE(4, 0, 1, 0);
#undef CHECKSANE
